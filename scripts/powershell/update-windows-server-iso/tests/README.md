...
python3 wsusscn2_deny_list_test.py         # T14: 10 EOS/ESU deny-list warned-exclusion assertions
python3 wsusscn2_servicing_stack_test.py   # T15: 16 servicing-stack extraction assertions
python3 wsusscn2_readiness_verdict_test.py # T16: 21 Phase 2c readiness verdict assertions
python3 wsusscn2_recency_fallback_test.py  # T17: 15 recency-fallback assertions
python3 wsusscn2_servicing_stack_populate_test.py # T18: 17 SS-populate (pure halves) assertions
python3 wsusscn2_data_contract_test.py     # T19: 11 data-contract consistency assertions
...
python3 wsusscn2_layer2_schema_test.py     # Layer 2 schema gate: data/servicing-dependency-database.json vs schema (16 assertions)
...
tests/
  ...
  wsusscn2_deny_list_test.py T14 (EOS/ESU deny-list warned-exclusion, allow-overrides, 10 assertions)
  wsusscn2_servicing_stack_test.py T15 (servicing-stack extraction: RANGESTART map + SS-model derivation, 16 assertions)
  wsusscn2_readiness_verdict_test.py T16 (Phase 2c readiness verdict: presence/SS-compare/supersession, 21 assertions)
  wsusscn2_recency_fallback_test.py T17 (recency fallback: out-of-scope KB -> newest in-scope LCU, 15 assertions)
  wsusscn2_servicing_stack_populate_test.py T18 (SS populate pure halves: leaf select + field populate, 17 assertions)
  wsusscn2_data_contract_test.py     T19 (data-contract consistency: Current/Stale/Refuse/Foreign/Unknown, 11 assertions)
  wsusscn2_scope_invariants_test.py  scope-invariants gate (EOS/ESU deny-list, allow-overrides; 23 assertions; no PowerShell)
  wsusscn2_layer2_schema_test.py     Layer 2 schema gate (committed DB vs schema + M1 invariants; 16 assertions; no PowerShell)
  common/
    ...
    wsusscn2_fixture_builder.py  Generator for the T12 fixture (`fixtures/servicing-dependency/package.xml` + `expected-output.json`); CLI + library
  fixtures/
    2026-05/
