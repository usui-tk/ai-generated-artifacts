...
reference Python PoC produced for the same input snapshot.

The reference PoC fixture is at fixtures/poc_release_info/release-info.json;
it was generated by tests/poc_release_info_02_parse.py against
snapshots/poc_release_info/release-info-<date>.md. This test reads the
same snapshot, invokes the PowerShell parser via the harness, and
compares the result.
...
FIXTURE_PATH = TESTS_DIR / "fixtures" / "poc_release_info" / "release-info.json"
