...
5. **Self-verification tool suite** — T1 through T17 (canonical inventory in [`tests/README.md`](./tests/README.md))
...
- [5. Self-verification tool suite (T1 – T17)](#5-self-verification-tool-suite-t1--t17)
...
## 5. Self-verification tool suite (T1 – T17)
