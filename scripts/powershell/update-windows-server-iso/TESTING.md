...
5. **Self-verification tool suite** — T1 through T16 (canonical inventory in [`tests/README.md`](./tests/README.md))
...
- [5. Self-verification tool suite (T1 – T16)](#5-self-verification-tool-suite-t1--t16)
...
| Stage 1 (Linux psa.py + PSScriptAnalyzer + T2/T3/T6-T16 + format gate + config schema gate + scope-invariants gate) | ✓ green | CI continuous |
...
## 5. Self-verification tool suite (T1 – T16)
