...
Run from the project root::
    ...
    python3 reference-code/powershell/tests/canonical_json_test.py
"""
...
# Canon-targeting: load ConvertTo/From-CanonicalJson + Save-CanonicalJsonFile
# from the reference-code/powershell canon via Invoke-CanonTestHarness.ps1,
# NOT from a consumer script (ADR 0010 - canon is standalone-testable).
SCRIPT_PATH = TESTS_DIR / "Invoke-CanonTestHarness.ps1"
