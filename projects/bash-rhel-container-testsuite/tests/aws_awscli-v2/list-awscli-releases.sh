#!/usr/bin/env bash
# ----- Purpose --------------------------------------------------------------
#   Refresh awscli-releases.json: enumerate upstream releases into the pinned
#   in-scope version set the install/build-test matrix consumes.
# ----- Prerequisites --------------------------------------------------------
#   bash 4+, curl; network to the vendor endpoint (GitHub/AWS).
# ----- Usage examples -------------------------------------------------------
#   bash tests/aws_awscli-v2/list-awscli-releases.sh
#   bash tests/aws_awscli-v2/list-awscli-releases.sh --help
# ----- Known limitations ----------------------------------------------------
