...
# In this suite the primary mocked surfaces are podman/curl/tar (acquisition)
# and dnf/yum/microdnf/rpm/repoquery (package-manager + entitlement detection).
#
# Ported verbatim from projects/bash-ol-aws-ami-builder/tests/lib/mock.sh
