...
On RHEL 7, the newest agent (3.3.4793.0) is **compliant-capable**. Agents below 3.3.3598.0 install but are ec2messages-only (no full Systems Manager).

| version | >= min | glibc (os) | install (empirical) |
|:--|:--|:--|:--|
| 3.3.4793.0 | yes | 2.17 | pending |
| 3.3.3598.0 | yes | 2.17 | pending |
| 3.0.1479.0 | no | 2.17 | pending |
