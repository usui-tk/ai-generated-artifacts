...
tests/
  ...
  research_reference_drift_test.py       T56 (research-reference drift guard v2 + alias check + STAGE 3 trigger pin, 51)
  a00_rebuild_guard_contract_test.py     T57 (A00 fail-closed guard placement + pre-v4 seed precondition pin, 10)
  config_schema_test.py                  config schema gate (28; declaration-based v3/v4 selection + production currentness + policy pins)
