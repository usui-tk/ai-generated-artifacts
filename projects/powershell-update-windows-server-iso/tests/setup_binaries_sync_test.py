...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.18 catalog-stable-identity-localization-isolation",
        "update-wsi-2026.07.18-r12.18" in code and "'catalog-stable-identity-localization-isolation'" in code,
