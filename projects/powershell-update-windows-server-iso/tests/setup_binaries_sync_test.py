...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.38 (tag retained: all-os-version-decision-hardening)",
        "update-wsi-2026.07.27-r12.38" in code and "'all-os-version-decision-hardening'" in code,
