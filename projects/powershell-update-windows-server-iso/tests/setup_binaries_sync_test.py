...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.21 dotnet-applicability-secureboot-v165-alignment",
        "update-wsi-2026.07.19-r12.21" in code and "'dotnet-applicability-secureboot-v165-alignment'" in code,
