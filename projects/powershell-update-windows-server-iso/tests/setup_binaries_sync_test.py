...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.75 (tag retained: post-install-evidence-collector-r9-merge)",
        "update-wsi-2026.08.07-r12.75" in code and "'post-install-evidence-collector-r9-merge'" in code,
