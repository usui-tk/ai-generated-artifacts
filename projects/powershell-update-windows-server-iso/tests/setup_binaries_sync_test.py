...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.55 (tag: setupdu-baseline-language-preservation)",
        "update-wsi-2026.08.01-r12.55" in code and "'setupdu-baseline-language-preservation'" in code,
