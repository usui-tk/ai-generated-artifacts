...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.61 (tag retained: setupdu-baseline-language-preservation)",
        "update-wsi-2026.08.02-r12.61" in code and "'setupdu-baseline-language-preservation'" in code,
