...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.69 (tag changed: post-install-evidence-artifact-naming)",
        "update-wsi-2026.08.04-r12.69" in code and "'post-install-evidence-artifact-naming'" in code,
