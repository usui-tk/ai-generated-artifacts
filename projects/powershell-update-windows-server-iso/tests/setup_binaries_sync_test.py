...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.32 (tag retained: rawxml-filetime-conversion-regression-fix)",
        "update-wsi-2026.07.25-r12.32" in code and "'rawxml-filetime-conversion-regression-fix'" in code,
