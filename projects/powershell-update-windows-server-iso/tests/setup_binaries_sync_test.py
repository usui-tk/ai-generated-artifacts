...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.40 (tag retained: all-os-version-decision-hardening)",
        "update-wsi-2026.07.28-r12.40" in code and "'all-os-version-decision-hardening'" in code,
