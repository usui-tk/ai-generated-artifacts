...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.36 offline-servicing-failure-forensics (part 2 of the double-work revision)",
        "update-wsi-2026.07.27-r12.36" in code and "'offline-servicing-failure-forensics'" in code,
