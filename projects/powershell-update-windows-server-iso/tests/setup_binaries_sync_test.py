...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.43 (tag retained: all-os-version-decision-hardening)",
        "update-wsi-2026.07.29-r12.43" in code and "'all-os-version-decision-hardening'" in code,
