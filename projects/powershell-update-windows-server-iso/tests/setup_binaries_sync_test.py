...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.65 (tag changed: catalog-setupdu-scalar-updateid-fix)",
        "update-wsi-2026.08.03-r12.65" in code and "'catalog-setupdu-scalar-updateid-fix'" in code,
