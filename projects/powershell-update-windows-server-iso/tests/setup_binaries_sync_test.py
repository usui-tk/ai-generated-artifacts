...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.25 measured-e2e-os-specific-servicing-and-catalog-rehydration",
        "update-wsi-2026.07.20-r12.25" in code and "'measured-e2e-os-specific-servicing-and-catalog-rehydration'" in code,
