...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.20 runtime-catalog-handoff-placeholder-fix",
        "update-wsi-2026.07.18-r12.20" in code and "'runtime-catalog-handoff-placeholder-fix'" in code,
