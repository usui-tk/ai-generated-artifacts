...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.44 safeos-p11-metadata-contract-isolation-stage1",
        "update-wsi-2026.07.29-r12.44" in code and "'safeos-p11-metadata-contract-isolation-stage1'" in code,
