...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.29 rawxml-creationtime-integrity-integration",
        "update-wsi-2026.07.24-r12.29" in code and "'rawxml-creationtime-integrity-integration'" in code,
