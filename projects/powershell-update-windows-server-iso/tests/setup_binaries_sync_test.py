...
def main() -> int:
    ...
    passed, failed = check(
        "version bumped to r12.19 catalog-scoped-product-identity-live-verified",
        "update-wsi-2026.07.18-r12.19" in code and "'catalog-scoped-product-identity-live-verified'" in code,
