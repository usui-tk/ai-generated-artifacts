...
### Remove the dead Dynamic Update cache subsystem and its title-token / supersedence cascade (11 functions, ~590 lines); move OS-scoping documentation onto the Catalog Products column (`$Script:ScriptVersion` -> `update-wsi-2026.06.28-r11.41`, tag `dynamic-update-cache-removal`)
