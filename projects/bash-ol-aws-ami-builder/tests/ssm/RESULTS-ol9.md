# SSM Agent install+run matrix -- OL9
...
## Test environment: OL9 kernel 5.15.0-321.202.5.1.el9uek.x86_64

- `env_kernel` : 5.15.0-321.202.5.1.el9uek.x86_64  (`rpm -q kernel-uek` -- the OL UEK a real instance runs)
