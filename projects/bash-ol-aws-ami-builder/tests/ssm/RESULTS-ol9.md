...
## Test environment: OL9 kernel 5.15.0-322.203.3.3.el9uek.x86_64

- `env_kernel` : 5.15.0-322.203.3.3.el9uek.x86_64  (`rpm -q kernel-uek` -- the OL UEK a real instance runs)
