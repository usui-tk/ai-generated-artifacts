# SSM Agent install+run matrix -- OL10
...
## Test environment: OL10 kernel 6.12.0-204.92.4.2.el10uek.x86_64

- `env_kernel` : 6.12.0-204.92.4.2.el10uek.x86_64  (`rpm -q kernel-uek` -- the OL UEK a real instance runs)
